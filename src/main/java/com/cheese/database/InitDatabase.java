package com.cheese.database;

import com.cheese.constant.AppConstants;
import com.cheese.database.repository.*;
import com.cheese.model.entity.*;
...
public class InitDatabase {
    ...
    private Post generatePost(User user, Category category){
        ...
        post.getImages().add(new Image("http://192.168.1.105/images/bubble/daisy.jpg"));
